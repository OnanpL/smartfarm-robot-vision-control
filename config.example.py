"""
config.example.py
실제 배포용 config.py의 템플릿입니다.
사용법: 이 파일을 config.py로 복사한 뒤, 아래 표시된 값들을 실제 값으로 채우세요.
...
CONFIG = {
    ...
    "mqtt_broker": "YOUR_SERVER_IP_HERE",
    ...
    "http_upload_url": "http://YOUR_SERVER_IP_HERE/api/upload/crop",
    ...
    "disease_api_key": "YOUR_PLANT_ID_API_KEY_HERE",  # ← 실제 발급받은 plant.id 키로 교체
...
CROP_COLOR_PROFILES = {
    ...
    "grape": {
        "hue_start": 60, "hue_end": 150, "direction": 1,
        "margin": 0.15, "min_saturation": 40,
        "disease_threshold": 0.35,
    },
    "strawberry": {
